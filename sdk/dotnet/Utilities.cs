...
namespace Pulumi.Myprovider
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Myprovider.version.txt");
    ...
    internal sealed class MyproviderResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public MyproviderResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
